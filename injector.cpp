...
NAN_METHOD(inject) {
    ...
    String::Utf8Value arg0(info[0]->ToString(Nan::GetCurrentContext()).FromMaybe(v8::String::Utf8Value()));
    String::Utf8Value arg1(info[1]->ToString(Nan::GetCurrentContext()).FromMaybe(v8::String::Utf8Value()));
